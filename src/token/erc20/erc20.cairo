...
// OpenZeppelin Contracts for Cairo v1.0.3-rc.10 (token/erc20/erc20.cairo)
...
/// See [the documentation](https://docs.openzeppelin.com/contracts-cairo/1.0.3-rc.10/guides/erc20-supply)
/// for examples.
#[starknet::component]
mod ERC20Component {
